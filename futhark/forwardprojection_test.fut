...
let preprocess [a](angles: [a]f32): ([](f32, f32, f32, i32), [](f32, f32, f32, i32)) =
  let cossin = map(\i -> let angle = unsafe angles[i]
...
let forwardprojection_flat [n] (lines: ([](f32, f32, f32, i32))) (rhozero: f32) (deltarho: f32) (numrhos:i32) (halfsize: i32) (img1: [n]f32) =
  let fhalfsize = r32(halfsize)
  let size = halfsize*2
