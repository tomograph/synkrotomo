...
def main(argv):
    ...
    tomo_lib.save_3D_slices(phantom,"..//output//samples//futhark_SIRT3D_phantom", size, 10);
    ...
    tomo_lib.save_3D_slices(sirtresult.reshape(size,size,size),"..//output//samples//futhark_SIRT3D", size, 10);
