...
# save a single projection image
import pylab
pylab.imsave("..//output//samples//s07_3d_reconstruction_singleprojectionimg.png", proj_data[:,20,:])
...
pylab.imsave("..//output//samples//s07_3d_reconstruction.png",rec[:,:,65])
