...
The backprojection and foward projection operations are standard operations in many iterative algebraic reconstruction methods and are the bottle necks of the algorithms \todo{insert citation here or just do runtime analysis of the different parts!}. Therefore, our main focus has been on optimizing these operations, and then combining these to the SIRT algorithm.\\
