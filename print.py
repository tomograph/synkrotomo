...
def futhark_FP(cfg):
    ...
    np.savetxt("test4.txt", cfg.rays, delimiter=',', newline=',')
    np.savetxt("test5.txt", cfg.angles, newline=',')
    # np.savetxt("test3.txt", cfg.phantom.flatten().astype(np.float32), delimiter=',', newline=',')
    # print(cfg.rays)
    # print(cfg.angles)
...
def main(argv):
    ...
    # pylab.imsave("nestedBP.png", test2)
